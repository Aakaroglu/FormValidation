...
const isNameValid = computed(() => formData.value.name1.trim() !== '')
const isEmailValid = computed(() => /^[^\&@]+@[^\&@]+\.[^\&@]+$/.test(formData.value.email))
...
<template>
    ...
    <div>
        ...
        <div class="form-group">
            ...
            <input v-model="formData.name1" type="text" id="name1">
